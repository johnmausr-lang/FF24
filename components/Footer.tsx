        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-16 mb-20 items-center">
          <div className="md:col-span-7 flex flex-col items-center md:items-start text-center md:text-left">
            ...
            <div className="space-y-6">
              <a href="https://t.me/manager24ff" target="_blank" className="text-4xl md:text-6xl font-black italic uppercase hover:text-accent-lime transition-all tracking-tighter">
                @manager24ff
              </a>
