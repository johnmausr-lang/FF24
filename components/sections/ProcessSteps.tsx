...
const steps = [
  { title: "Заявка", desc: "Регистрация и передача ТЗ", icon: <ClipboardList className="w-16 h-16 text-accent-lime" /> },
  { title: "Забор", desc: "Забираем товар у поставщика", icon: <Truck className="w-16 h-16 text-accent-lime" /> },
  { title: "Приёмка", desc: "Сверка и проверка на брак", icon: <HardHat className="w-16 h-16 text-accent-lime" /> },
  { title: "Маркировка", desc: "Наклейка штрих-кодов по ТЗ", icon: <Factory className="w-16 h-16 text-accent-lime" /> },
  { title: "Упаковка", desc: "Оптимальная упаковка в короба", icon: <PackageCheck className="w-16 h-16 text-accent-lime" /> },
  { title: "Отгрузка", desc: "Доставка на склад МП за 24ч", icon: <Download className="w-16 h-16 text-accent-lime rotate-180" /> },
  { title: "Финиш", desc: "Товар готов к продаже", icon: <CheckCircle2 className="w-16 h-16 text-accent-lime" /> },
];
