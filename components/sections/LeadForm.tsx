...
export const LeadForm = () => {
  ...
  return (
    <section id="lead" className="py-32 px-6">
      <div className="max-w-5xl mx-auto">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="glass-card glass-hover p-12 md:p-20"
        >
              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                  <div className="flex flex-col items-center gap-4">
                    ...
                    <p className="text-lg font-bold text-white">Расчёт за 24 часа</p>
                  </div>
                  <div className="flex flex-col items-center gap-4">
                    <div className="w-16 h-16 rounded-full glass bg-white/10 border border-white/20 flex items-center justify-center">
                      <Check className="w-8 h-8 text-accent-lime" />
                    </div>
                    <p className="text-lg font-bold text-white">Скидка 10% на первый месяц</p>
                  </div>
                  <div className="flex flex-col items-center gap-4">
                    <div className="w-16 h-16 rounded-full glass bg-white/10 border border-white/20 flex items-center justify-center">
                      <Check className="w-8 h-8 text-accent-lime" />
                    </div>
                    <p className="text-lg font-bold text-white">Персональный менеджер</p>
                  </div>
                </div>

                <button
                  onClick={handleClick}
                  className="btn-glass-lime px-16 py-8 text-2xl md:text-3xl"
                >
                  Написать в Telegram
                </button>
              </motion.div>
